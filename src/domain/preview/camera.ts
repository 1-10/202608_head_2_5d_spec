...
// `Scenes/Viewer.unity` の `MainCamera` の写し（画角 20° / y 0.297m / z 1.3m）。Unity 空間は GNM
// 空間の X を反転した左手系なので（根拠は `domain/preview/pose` の「角度の向き」）、正面から外れる
// と x と yaw の符号があちらとは入れ替わる。
